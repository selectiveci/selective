    ...
    module ActionView
      class RenderedTemplateCollectorTest < ActiveSupport::TestCase
        def test_render__records_rendered_template
          ...
          Selective.expects(:add_covered_templates).never
          ...
          Selective::Collectors::ActionView::RenderedTemplateCollector.subscribe(mock_collector)
          assert_not_nil Selective::Collectors::ActionView::RenderedTemplateCollector.subscriber
          view.render(template: 'foo.html.erb')
        ensure
          Selective::Collectors::ActionView::RenderedTemplateCollector.unsubscribe
          assert_nil Selective::Collectors::ActionView::RenderedTemplateCollector.subscriber
        end
      end
    end
  end
